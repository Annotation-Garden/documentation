...
# Note: Only include modules that exist and have proper docstrings
PROJECTS = {
    "hedit": {
        "src_path": Path("../hedit/src"),
        "doc_path": "projects/hedit/reference",
        "modules": [
            "api.main",
            "api.models",
            "cli.main",
            ...
            "cli.client",
            "agents.workflow",
            "validation.hed_validator",
        ],
    },
    # image-annotation modules will be added once package structure is finalized
    # "image-annotation": {
    #     "src_path": Path("../image-annotation/src/image_annotation"),
    #     "doc_path": "projects/image-annotation/reference",
    #     "modules": [
...
def generate_reference_docs():
    ...
    for project_name, config in PROJECTS.items():
        ...
        for module in config["modules"]:
            ...
            full_module = f"src.{module}" if project_name == "hedit" else f"image_annotation.{module}"
...
"""
            ...
            mkdocs_gen_files.set_edit_path(doc_file, f"../{src_path / module.replace('.', '/')}.py")
